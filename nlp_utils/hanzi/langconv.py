...
try:
    ...
    from nlp_utils.hanzi.zh_wiki import zh2Hant, zh2Hans
...
if __name__ == '__main__':
    # run()
    print(Converter('zh-hant').convert("<>123asdasd把中文字符串进行繁体和简体中文的转换"))
    print(Converter('zh-hans').convert("<>123asdasd把中文字符串進行繁體和簡體中文的轉換"))
